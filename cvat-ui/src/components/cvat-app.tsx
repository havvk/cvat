                        ...
                        <Switch>
                            ...
                            <Route
                                ...
                                render={() => {
                                    ...
                                    if (invitationKey) {
                                        return <Redirect to={`/auth/invitation/confirm?invitation=${invitationKey}`} />;
                                    }
                                    return <Redirect to={location.pathname.length > 1 ? `/auth/login?next=${location.pathname}` : '/auth/login'} />;
                                }}
                            />
                        </Switch>
                        <InvitationWatcher />
